...
CommandCost BuildModularAirportTile_Check(DoCommandFlags flags, TileIndex tile, uint16_t gfx, uint8_t rotation, StationID station_to_join, bool allow_adjacent, Station *&st, bool &is_modular_replace, bool &is_noop_rebuild, CommandCost &cost, bool check_noise = true);
