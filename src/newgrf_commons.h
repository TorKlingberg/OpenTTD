...
protected:
	 ...
	 *
	 * Upstream removed this hook in 4d4f8bff38 as unneeded, having no overrides of its
	 * own. AirportOverrideManager overrides it to keep runtime airport ID 127 free for
	 * AT_MODULAR, so it is kept here.
	 *
