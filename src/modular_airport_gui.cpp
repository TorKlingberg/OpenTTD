...
static constexpr CosmeticPiece _cosmetic_pieces[] = {
	...
	{STR_STATION_BUILD_MODULAR_AIRPORT_PIECE_SMALL_BUILDING_1, SPR_AIRFIELD_TERM_C_BUILD,   APT_SMALL_BUILDING_1,     0},
	{STR_STATION_BUILD_MODULAR_AIRPORT_PIECE_SMALL_BUILDING_2, SPR_AIRFIELD_TERM_B,         APT_SMALL_BUILDING_2,     0},
	{STR_STATION_BUILD_MODULAR_AIRPORT_PIECE_SMALL_BUILDING_3, SPR_AIRFIELD_TERM_A,         APT_SMALL_BUILDING_3,     0},
};
		...
		NWidget(NWID_VERTICAL), SetPIP(0, WidgetDimensions::unscaled.vsep_normal, 0),
			...
			NWidget(NWID_HORIZONTAL), SetPIP(0, WidgetDimensions::unscaled.hsep_normal, 0), SetPIPRatio(1, 0, 1),
				NWidget(WWT_TEXTBTN, COLOUR_GREY, WID_MACP_PIECE_8), SetFill(0, 0),
					SetToolTip(STR_STATION_BUILD_MODULAR_AIRPORT_PIECE_SMALL_BUILDING_1),
				NWidget(WWT_TEXTBTN, COLOUR_GREY, WID_MACP_PIECE_9), SetFill(0, 0),
					SetToolTip(STR_STATION_BUILD_MODULAR_AIRPORT_PIECE_SMALL_BUILDING_2),
				NWidget(WWT_TEXTBTN, COLOUR_GREY, WID_MACP_PIECE_10), SetFill(0, 0),
					SetToolTip(STR_STATION_BUILD_MODULAR_AIRPORT_PIECE_SMALL_BUILDING_3),
			EndContainer(),
		EndContainer(),
	EndContainer(),
};
