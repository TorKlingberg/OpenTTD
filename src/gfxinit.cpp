...
static void LoadSpriteTables()
{
	...
	uint total_extra_graphics = SPR_MIRRORED_BASE - SPR_OPENTTD_BASE;
	Debug(sprite, 4, "Checking sprites from fallback grf");
	_missing_extra_graphics = GetSpriteCountForFile(default_filename, SPR_OPENTTD_BASE, SPR_MIRRORED_BASE);
