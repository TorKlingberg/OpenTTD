...
enum class Commands : uint8_t {
	...
	BuildModularAirportTile, ///< build a modular airport tile
	SetRunwayFlags, ///< set runway usage flags on modular airport tiles
	SetTaxiwayFlags, ///< set one-way taxi flags on modular airport taxiway tiles
	BuildModularAirportFromStock, ///< build a stock airport as a modular airport
	SetModularAirportEdgeFence, ///< toggle edge fence on modular airport tile
	PlaceModularAirportTemplate, ///< place a saved modular airport template atomically
	UpgradeModularAirportTile, ///< upgrade old modular airport tiles to modern variants
